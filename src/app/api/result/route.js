...
//     const existingScore = await Scores.findOne({ user: decodedToken.userId });
//     if (existingScore) {
//       return NextResponse.json({
//         success: false,
//         status: 400,
//         msg: "You have already submitted a score",
//       });
//     }
...
//     const categoryScores = Object.entries(responses).map(([categoryId, questions]) => {
...
//       data: savedScore,
//       status: 200,
//       msg: "POST request processed successfully",
//     });
//   } catch (error) {
